...
public class FishingSkillTree extends SkillTree {
    ...
    private void buildSkillTree() {
        ...
        getTree().put(basicFishing.getSkillName(), basicFishing);
        ...
        getTree().put(fishingBait.getSkillName(), fishingBait);
        ...
        getTree().put(fishingTechnique.getSkillName(), fishingTechnique);
        ...
        getTree().put(fishermanFolkStories.getSkillName(), fishermanFolkStories);
        ...
        getTree().put(rodCare.getSkillName(), rodCare);
        ...
        getTree().put(currentWatcher.getSkillName(), currentWatcher);
        ...
        getTree().put(grizzlyInstincts.getSkillName(), grizzlyInstincts);
        ...
        getTree().put(oceanography.getSkillName(), oceanography);
        ...
        getTree().put(deadliestCatch.getSkillName(), deadliestCatch);
        ...
        getTree().put(fisherman.getSkillName(), fisherman);
        ...
        getTree().put(fishermanDiet.getSkillName(), fishermanDiet);
        ...
        getTree().put(pirateLore.getSkillName(), pirateLore);
        ...
        getTree().put(pirateSuperstition.getSkillName(), pirateSuperstition);
        ...
        getTree().put(trolling.getSkillName(), trolling);
        ...
        getTree().put(nets.getSkillName(), nets);
        ...
        getTree().put(fishermanLuck.getSkillName(), fishermanLuck);
        ...
        getTree().put(proficientFisherman.getSkillName(), proficientFisherman);
        ...
        getTree().put(sushi.getSkillName(), sushi);
        ...
        getTree().put(fishCleaning.getSkillName(), fishCleaning);
        ...
        getTree().put(pirateMaps.getSkillName(), pirateMaps);
        ...
        getTree().put(sonar.getSkillName(), sonar);
        ...
        getTree().put(freshwaterBaits.getSkillName(), freshwaterBaits);
        ...
        getTree().put(oceanBaits.getSkillName(), oceanBaits);
        ...
        getTree().put(masterAngler.getSkillName(), masterAngler);
        ...
        getTree().put(pirateLegends.getSkillName(), pirateLegends);
        ...
        getTree().put(seafarerWisdom.getSkillName(), seafarerWisdom);
        ...
        getTree().put(aquaticInsight.getSkillName(), aquaticInsight);
        ...
        getTree().put(shipwreckDiving.getSkillName(), shipwreckDiving);
        ...
        getTree().put(bottomTrawling.getSkillName(), bottomTrawling);
        ...
        getTree().put(electrofishing.getSkillName(), electrofishing);
        ...
        getTree().put(sustainableFishing.getSkillName(), sustainableFishing);
        ...
        getTree().put(cleanWaters.getSkillName(), cleanWaters);
