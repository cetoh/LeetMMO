...
public class MiningSkillTree extends SkillTree {
    ...
    private void buildSkillTree() {
        ...
        getTree().put(basicMining.getSkillName(), basicMining);
        ...
        getTree().put(miningExpertise.getSkillName(), miningExpertise);
        ...
        getTree().put(hewer.getSkillName(), hewer);
        ...
        getTree().put(ligniteExtraction.getSkillName(), ligniteExtraction);
        ...
        getTree().put(thermoluminescenceDating.getSkillName(), thermoluminescenceDating);
        ...
        getTree().put(siliconeExtraction.getSkillName(), siliconeExtraction);
        ...
        getTree().put(foolsGold.getSkillName(), foolsGold);
        ...
        getTree().put(tunnelDweller.getSkillName(), tunnelDweller);
        ...
        getTree().put(templeDesecrator.getSkillName(), templeDesecrator);
        ...
        getTree().put(blastMining.getSkillName(), blastMining);
        ...
        getTree().put(bituminousExtraction.getSkillName(), bituminousExtraction);
        ...
        getTree().put(comminution.getSkillName(), comminution);
        ...
        getTree().put(lazuriteExtractionEfficiency.getSkillName(), lazuriteExtractionEfficiency);
        ...
        getTree().put(prospector.getSkillName(), prospector);
        ...
        getTree().put(xrayFlourescence.getSkillName(), xrayFlourescence);
        ...
        getTree().put(postlapidaryOiling.getSkillName(), postlapidaryOiling);
        ...
        getTree().put(anthraciteExtraction.getSkillName(), anthraciteExtraction);
        ...
        getTree().put(gravitySeparation.getSkillName(), gravitySeparation);
        ...
        getTree().put(hydraulicMining.getSkillName(), hydraulicMining);
        ...
        getTree().put(geoengineer.getSkillName(), geoengineer);
        ...
        getTree().put(electromagneticRadation.getSkillName(), electromagneticRadation);
        ...
        getTree().put(cuttingEfficiency.getSkillName(), cuttingEfficiency);
        ...
        getTree().put(wurtziteBoronNitrideDrill.getSkillName(), wurtziteBoronNitrideDrill);
        ...
        getTree().put(mantleDrilling.getSkillName(), mantleDrilling);
        ...
        getTree().put(magnetiteFrothFlotation.getSkillName(), magnetiteFrothFlotation);
        ...
        getTree().put(leaching.getSkillName(), leaching);
        ...
        getTree().put(miningMastery.getSkillName(), miningMastery);
