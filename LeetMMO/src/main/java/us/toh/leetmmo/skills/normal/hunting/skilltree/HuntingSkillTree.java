...
public class HuntingSkillTree extends SkillTree {
    ...
    private void buildSkillTree() {
        ...
        getTree().put(chickenCatcher.getSkillName(), chickenCatcher);
        ...
        getTree().put(gameHunter.getSkillName(), gameHunter);
        ...
        getTree().put(noviceMonsterHunting.getSkillName(), noviceMonsterHunting);
        ...
        getTree().put(undeadStalker.getSkillName(), undeadStalker);
        ...
        getTree().put(snares.getSkillName(), snares);
        ...
        getTree().put(gameCleaning.getSkillName(), gameCleaning);
        ...
        getTree().put(wildernessResourcefulness.getSkillName(), wildernessResourcefulness);
        ...
        getTree().put(pestControl.getSkillName(), pestControl);
        ...
        getTree().put(expertSkinning.getSkillName(), expertSkinning);
        ...
        getTree().put(intermediateMonsterHunter.getSkillName(), intermediateMonsterHunter);
        ...
        getTree().put(scavenger.getSkillName(), scavenger);
        ...
        getTree().put(hunterInsight.getSkillName(), hunterInsight);
        ...
        getTree().put(wildernessToughness.getSkillName(), wildernessToughness);
        ...
        getTree().put(wildernessReflexes.getSkillName(), wildernessReflexes);
        ...
        getTree().put(expertMonsterHunter.getSkillName(), expertMonsterHunter);
        ...
        getTree().put(monsterLessons.getSkillName(), monsterLessons);
        ...
        getTree().put(monsterLore.getSkillName(), monsterLore);
        ...
        getTree().put(situationalAwareness.getSkillName(), situationalAwareness);
        ...
        getTree().put(deftStrikes.getSkillName(), deftStrikes);
        ...
        getTree().put(calluses.getSkillName(), calluses);
        ...
        getTree().put(flexibility.getSkillName(), flexibility);
